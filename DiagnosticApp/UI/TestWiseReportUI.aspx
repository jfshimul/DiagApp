<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TestWiseReportUI.aspx.cs" Inherits="DiagnosticApp.UI.TestWiseReportUI" %>
...
<div style="padding:5px;float:left;margin:auto;margin-left:70px;">
    <h2 style="padding:4px;">Test Wise Report</h2>
</div>
...
<table style="padding-left:-200px; width:100%;">
    ...
    <tr>
        ...
        <td class="auto-style8">
            <h3 style="background:url(../images/outright_logo.gif) no-repeat; margin-left:-100px;padding-left:50px">Test Wise Report :) </h3>
            <br/>
            <asp:GridView ID="testWiseReportGridView" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                          HeaderStyle-CssClass="header" RowStyle-CssClass="rows" runat="server"
                          AutoGenerateColumns="False"
                          Width="570px"
                          EmptyDataText="No records has been shown." CaptionAlign="Right" OnRowDataBound="testWiseReportGridView_RowDataBound" OnSelectedIndexChanged="testWiseReportGridView_SelectedIndexChanged">
            <Columns>
