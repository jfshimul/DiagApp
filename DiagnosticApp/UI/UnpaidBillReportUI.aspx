<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UnpaidBillReportUI.aspx.cs" Inherits="DiagnosticApp.UI.UnpaidBillReportUI" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding:5px;float:left;margin:auto;margin-left:70px;">
        <h2 style="padding:4px;">Unpaid Bill Report</h2>
    </div>
    ...
    <table style="padding-left:-200px; width:100%;">
        ...
        <tr>
            ...
            <td class="auto-style4">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                            ...
                                            ForeColor="red" 
                                            ErrorMessage="From Date Is Empty!"> </asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style4">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                            ...
                                            ValidationGroup="reportParam" 
                                            ForeColor="red" 
                                            ErrorMessage="To Date Is Empty!"> </asp:RequiredFieldValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <h3 style="background:url(../images/outright_logo.gif) no-repeat; margin-left:-100px;padding-left:50px">Unpaid Bill Report :) </h3>
                <br/>
                <asp:GridView ID="unpaidBillReportGridView" CssClass="mydatagrid" PagerStyle-CssClass="pager"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="testTypeIdLabel" runat="server" Visible="False" Text='<%# Eval("PatientId") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Patient Name">
                            <ItemTemplate>
                                <asp:Label ID="totalTestLabel" runat="server" Text='<%# Eval("PatientName") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Paid Amount">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("PaidAmount") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Due Amount">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("DueAmount") %>'></asp:Label>
                            </ItemTemplate>
        ...
        <tr>
            <td class="auto-style7"> <asp:Label ID="totalAmLabel" runat="server" Text="Total Bill :" style="font-weight: 700"></asp:Label> </td>
            <td class="auto-style8"> <asp:Label ID="totalAmountLabel" runat="server"></asp:Label></td>
        </tr>
    
        <tr>
            <td class="auto-style7"> <asp:Label ID="totalDueAmtLabel" runat="server" Text="Total Due :" style="font-weight: 700"></asp:Label> </td>
            <td class="auto-style8"> <asp:Label ID="totalDueAmountLabel" runat="server"></asp:Label></td>
        </tr>
